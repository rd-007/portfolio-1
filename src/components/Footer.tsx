...
export function Footer() {
  return (
    <footer className="border-t border-[var(--border)] bg-[var(--surface)]" role="contentinfo">
      <div className="max-w-[var(--layout-max-width)] mx-auto px-[var(--space-4)] py-[var(--space-12)]">
        <div className="flex flex-col md:flex-row items-center justify-between gap-[var(--space-6)]">
          ...
          <div className="flex items-center gap-[var(--space-6)]">
            <a
              ...
              className="link-external text-[var(--text-secondary)] hover:text-[var(--accent)] transition-colors duration-150 focus-visible:outline-[var(--focus-ring)]"
